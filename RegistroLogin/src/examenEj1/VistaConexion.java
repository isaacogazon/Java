...
public class VistaConexion extends GridPane {
	...
	public VistaConexion() throws SQLException {
		...
		this.jdbc.getItems().addAll("com.mysql.jdbc.Driver", "oracle.jdbc.driver.OracleDriver");
		
		this.database.getItems().addAll("jdbc:mysql://localhost/javabook", "jdbc:oracle:thin:@127.0.0.1:1521:XE");
	...
	public ComboBox getJdbc() {
		return jdbc;
	}

	public ComboBox getDatabase() {
		return database;
	}
